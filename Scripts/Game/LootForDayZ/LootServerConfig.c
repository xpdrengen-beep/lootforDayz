...
class LootServerConfigManager
{
	...
	static array<ref LootEntry> GetLootTable(string category, array<ref LootEntry> fallbackTable)
	{
		Load();
		...
		array<ref LootEntry> configuredTable = CategoryTables.Get(category);
